...
from stable_baselines3.common.buffers import DictReplayBuffer, ReplayBuffer, PrioritizedReplayBuffer_
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        if self.replay_buffer_class == PrioritizedReplayBuffer_:
            self.replay_buffer = PrioritizedReplayBuffer_(
